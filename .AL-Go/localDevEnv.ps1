...
$webClient.DownloadFile('https://raw.githubusercontent.com/byndit/AL-Go-Actions/build-hooks/Github-Helper.psm1', $GitHubHelperPath)
Write-Host "Downloading AL-Go Helper script"
$ALGoHelperPath = "$([System.IO.Path]::GetTempFileName()).ps1"
$webClient.DownloadFile('https://raw.githubusercontent.com/byndit/AL-Go-Actions/build-hooks/AL-Go-Helper.ps1', $ALGoHelperPath)
